            ...
            <form action="{{ route('coach.classes.update', $class) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select name="level"
                                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            <option value="iniciacion" {{ old('level', $class->level) == 'iniciacion' ? 'selected' : '' }}>Iniciación</option>
                            <option value="intermedio" {{ old('level', $class->level) == 'intermedio' ? 'selected' : '' }}>Intermedio</option>
                            <option value="avanzado"   {{ old('level', $class->level) == 'avanzado'   ? 'selected' : '' }}>Avanzado</option>
                        </select>
                        @error('level')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="mb-6">
                    ...
                    <select name="status"
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        <option value="scheduled"  {{ old('status', $class->status) == 'scheduled'  ? 'selected' : '' }}>Programada</option>
                ...
                <div class="mb-6 bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        @foreach($class->enrollments->where('status', 'enrolled') as $enrollment)
