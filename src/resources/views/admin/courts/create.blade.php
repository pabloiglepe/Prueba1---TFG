        ...
        <div style="background: #fff; border-radius: 12px; border: 0.5px solid #d4d9cc; padding: 28px;">
            ...
            <form action="{{ route('admin.courts.store') }}" method="POST">
                ...
                <div style="display: flex; justify-content: flex-end; gap: 10px;">
                    <a href="{{ route('admin.courts.index') }}"
                       style="display: inline-flex; align-items: center; padding: 9px 18px; border-radius: 8px; border: 0.5px solid #d4d9cc; font-size: 14px; color: #5a6b5a; text-decoration: none; font-weight: 500;"
                    ...
                    <button type="submit"
                        ...
                        <iconify-icon icon="ph:floppy-disk-light" style="font-size: 15px;"></iconify-icon>
                        Crear Pista
                    </button>
                </div>
